          ...
          <div class="x_content">
            <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
              <div class="profile_img">
                <div id="crop-avatar">
                  <!-- Current avatar -->
                  <img class="img-responsive avatar-view" src="{{URL('images/foto/'.$user->foto)}}" alt="Avatar"
              ...
              <ul class="list-unstyled user_data">
                ...
                <li><i class="fa fa-calendar user-profile-icon"></i> {{ date('d-M-Y', strtotime($user->tanggalLahir)) }}
                </li>
