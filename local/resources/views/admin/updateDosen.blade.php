  ...
  <div class="login_wrapper">
    ...
    <div class="animate form login_form">
      ...
      <section class="login_content">
        ...
        {!! Form::open(['method' => 'PUT' , 'action' => ['superAdminController@updateDosen',$dosen->id],'class'
        =>"form-horizontal form-label-left",'enctype'=> "multipart/form-data" ,"novalidate" ] ) !!}
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input id="nrp" name="nrp" class="form-control col-md-7 col-xs-12" value="{{$dosen->nik}}" name="nrp"
              placeholder="e.g 1472088" required="required" type="number" onkeypress="return isNumeric(event)"
              oninput="maxLengthCheck(this)" type="number" maxlength="7" min="1" max="9999999">
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input id="nama" class="form-control col-md-7 col-xs-12" value="{{$dosen->namaDosen}}" name="nama"
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="email" id="email" name="email" value="{{$dosen->email}}" required="required"
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="email" id="email2" value="{{$dosen->email}}" name="confirm_email" data-validate-linked="email"
              required="required" placeholder="Steven.yong@outlook.com" class="form-control col-md-7 col-xs-12">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <select class="form-control" required="required" id="prodi" name="prodi">
              ...
              <optgroup label="Fakultas Teknologi Informasi">
                ...
                <?php if ($dosen->prodi == "S-1 Sistem Informasi Bisnis"): ?>
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="radio" class="flat" name="gender" id="genderF" value="Wanita" checked="true"
              required="required" />
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input id="kota" value="{{$dosen->kota}}" class="form-control col-md-7 col-xs-12" name="kota"
              placeholder="Bandung" required="required" type="text">
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input id="gambar" type="file" name="gambar" value="{{$dosen->foto}}" required="required"
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input id="alamat" class="form-control col-md-7 col-xs-12" value="{{$dosen->alamat}}" name="alamat"
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <select class="form-control" required="required" id="role" name="role">
              ...
              <?php if ($dosen->role == "Dosen"): ?>

              <option value="Mahasiswa">Mahasiswa</option>

              <option value="Dosen" selected>Dosen</option>

              <option value="PJS">Dosen PJS</option>

              <?php  elseif($dosen->role == "Mahasiswa"): ?>
              ...
              <option value="PJS" selected>Dosen PJS</option>
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="url" id="streamlink" value="{{$dosen->streamlink}}" name="streamlink"
              placeholder="e.g UCdjcM0dxFRLvVtGTBlv5Q0Q" class="form-control col-md-7 col-xs-12">
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input id="warna" name="warna" required="required" value="{{$dosen->warna}}"
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input id="level" name="level" required="required" value="{{$dosen->level}}"
              class="form-control col-md-7 col-xs-12" type="number" onkeypress="return isNumeric(event)"
              oninput="maxLengthCheck(this)" min="1">
        ...
        <div class="item form-group">
          ...
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="experience"> Experience <span
              class="required">*</span>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input id="experience" name="experience" value="{{$dosen->experience}}" required="required"
              class="form-control col-md-7 col-xs-12" type="number" onkeypress="return isNumeric(event)"
              oninput="maxLengthCheck(this)" min="1">
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input id="telephone" name="telephone" value="{{$dosen->telephone}}" required="required"
              placeholder="e.g 081221669924" class="form-control col-md-7 col-xs-12" type="number"
              onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)" maxlength="13" min="1"
              max="9999999999999">
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <textarea id="about" name="about" class="form-control col-md-7 col-xs-12" rows="4"
              cols="50">{!! $dosen->about !!}</textarea>
