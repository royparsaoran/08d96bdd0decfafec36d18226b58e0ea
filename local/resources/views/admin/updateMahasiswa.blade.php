      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            {!! Form::open(['method' => 'PUT' , 'action' => ['superAdminController@updateMahasiswa',$mahasiswa->id],'class' =>"form-horizontal form-label-left",'enctype'=> "multipart/form-data" ,"novalidate" ]  ) !!}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="nrp" name="nrp" class="form-control col-md-7 col-xs-12" value="{{$mahasiswa->nrp}}" name="nrp" placeholder="e.g 1472088" required="required" type="number" onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)" type = "number" maxlength = "7" min = "1" max = "9999999">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="nama" class="form-control col-md-7 col-xs-12" value="{{$mahasiswa->namaMhs}}"  name="nama" placeholder="name(s) e.g Steven Yong" required="required" type="text">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="email" id="email" value="{{$mahasiswa->email}}" name="email" required="required" placeholder="Steven.yong@outlook.com" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="email" id="email2" value="{{$mahasiswa->email}}" name="confirm_email" data-validate-linked="email" required="required" placeholder="Steven.yong@outlook.com" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select class="form-control" required="required" id="prodi" name="prodi">
                    ...
                    <optgroup label="Fakultas Teknologi Informasi">
                      <?php if ($mahasiswa->prodi == "S-1 Sistem Informasi Bisnis"): ?>
...
<!--
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <?php if ($mahasiswa->gender == "Wanita"): ?>
                    Pria :
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="kota" class="form-control col-md-7 col-xs-12" value="{{$mahasiswa->kota}}" name="kota" placeholder="Bandung" required="required" type="text">
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="gambar" type="file" value="{{$mahasiswa->foto}}" name="gambar" required="required" class="optional form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="alamat" class="form-control col-md-7 col-xs-12" value="{{$mahasiswa->alamat}}" name="alamat" placeholder="e.g Jl. Prof. drg. Surya Sumantri, M.P.H. No. 65 " required="required" type="text">
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="url" id="streamlink" value="{{$mahasiswa->streamlink}}" name="streamlink"  placeholder="e.g UCdjcM0dxFRLvVtGTBlv5Q0Q" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
                ...
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="status"> Status <span class="required">*</span>
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select class="form-control" required="required" id="status" name="status">
                      <?php if ($mahasiswa->status == "offline"): ?>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input  id="warna" name="warna" required="required" value="{{$mahasiswa->warna}}" class="form-control col-md-7 col-xs-12" type = "text" >
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input  id="level" name="level" required="required" value="{{$mahasiswa->level}}" class="form-control col-md-7 col-xs-12" type="number" onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)"  min = "1" max="999999999999999999999999999999" maxlength = "30" >
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input  id="experience" name="experience" value="{{$mahasiswa->experience}}" required="required"  class="form-control col-md-7 col-xs-12" type="number" onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)"  min = "1" max="999999999999999999999999999999" maxlength = "30">
                </div>
              </div>
              <div class="item form-group">
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input  id="telephone" value="{{$mahasiswa->telephone}}" name="telephone" required="required"  placeholder="e.g 081221669924" class="form-control col-md-7 col-xs-12" type="number" onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)" type = "number" maxlength = "13" min = "1" max = "9999999999999">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea id="about" name="about" class="form-control col-md-7 col-xs-12" rows="4" cols="50">{!! $mahasiswa->about !!}</textarea>
                </div>
              </div>
