                         ...
                         <tbody>
                           <?php foreach ($tournament as $tour): ?>
                             <tr>
                               ...
                               <td>{{$tour->namaMK}}</td>
                               <td>{{$tour->creator}}</td>
                              <td class=" "><a href="{{Url('/tournamentAdmin/register/'.$tour->id)}}"><button type="button" class="btn btn-info">Detail</button></a></td>
                             </tr>
                           <?php endforeach; ?>
                       ...
                       <tbody>
                         <?php foreach ($tournament as $tour): ?>
                           <tr>
                             ...
                             <td>{{$tour->namaMK}}</td>
                             <td>{{$tour->creator}}</td>
                            <td class=" "><a href="{{Url('/tournamentAdmin/registered/'.$tour->id)}}"><button type="button" class="btn btn-primary">Detail</button></a></td>
                           </tr>
                         <?php endforeach; ?>
