                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div style="background-color: #2a3f54">
                            ...
                            <h1 style="text-align: center ;color:white">{{$key->name}}</h1>
                        ...
                        <form method="POST" action="{{url('submitEditDataGroupAdmin')}}">
                            <div>
                                <label for="heard">
                                    <h4><b>Group Name :</b></h4>
                                </label>
                                <input type="text" name="groupName" id="groupName" required class="form-control"
                                    placeholder="Insert Group Name" value="{{$groupList[0]->name}}">
                            </div>
                            <table class="table display table-bordred table-striped  table-hover"">
                                <p>
                                <thead>
                                    <tr class="bg-primary">
                                        <th scope="col">NRP</th>
                                ...
                                <tbody>
                                    <?php foreach ($groupList as $m) : ?>
                                    <tr>
                                        <td>{{$m->nrp}}</td>
                                        <td>{{$m->namaMhs}}</td>
                                        <td style="text-align: center">
                                            <input type="checkbox" name="listLama[]" value="{{$m->nrp}}"
                            ...
                            <hr style="width:100%;text-align:left;margin-left:0;border-width:5px">
                            ...
                            <input type="hidden" name="idgroupmahasiswa" value="{{$id}}">
                            <center><input type="submit" class="btn btn-success" value="Edit Group"></center>
                            {{ csrf_field() }}
                        </form>
