                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                              ...
                              <div class="row">
                                <div class="col-sm-12">
                                  <div class="card-box table-responsive">
                                   <form method="POST" action="leaderboardController@detail">
                                    <table id="datatable" class="table table-striped table-bordered" style="color:black">
                                      ...
                                      <?php foreach ($dkbs as $dk): ?>
                                        <tr>
                                          ...
                                          <td>{{$dk->dosen}}</td>
                                            <td class=" "><a href="{{URL('/leaderboardDosen/'.$dk->id)}}"><button type="button" class="btn btn-info">Detail</button></a></td>
                                        </tr>
                                      <?php endforeach; ?>
                                      </tbody>
                                    </table>
