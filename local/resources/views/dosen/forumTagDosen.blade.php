    ...
    <div class="col-md-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          {{--  --}}
          <div class="col-12">
            {{-- <form class="form-inline" action="{{ URL::asset("/forumTitlePublicDosen/search") }}" method="POST">
            {{ csrf_field() }}
            ...
            <span>
              <a href="forumNewPost" class="btn btn-primary"><b>+</b>
                Create
                Post</a>
              <a href="forumManageTopics" class="btn btn-primary"><b>+</b>
                Manage
                Topic</a>
            </span>
          </div>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="{{ URL::asset('forumDosen/delete/'.$to->post_id) }}" class="btn btn-primary">
                        OK</a>
                    </div>
          ...
          <a type="button" class="btn btn-primary btn-lg pull-left" href="{{ URL::asset('/forumTitleMKDosen') }}">
