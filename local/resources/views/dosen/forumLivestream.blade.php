...
<head>
  <title>CLSReborns Streaming</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
</head>

<body>
  <h1 class="bg-primary" text-align="center">
    {{ $kelas->kodeMK.' - '.$kelas->namaMK.' - '.$kelas->kelas }}
  </h1>
  ...
  <div class="modal fade" id="modalForm">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <input type="hidden" id="form-appid" value="dd06eeec5dfb475cba2d281f0efe0bcb">
        <input type="hidden" id="form-channel" value="{{ $id }}">
...
<script src="{{ URL::asset('vendors/agora/AgoraRTCSDK-3.0.2.js') }}"></script>
...
<script src="{{ URL::asset('vendors/agora/ui.js') }}"></script>
<script src="{{ URL::asset('vendors/agora/agora-interface.js') }}"></script>
<link rel="stylesheet" type="text/css" href="{{ URL::asset('vendors/agora/style.css') }}" />
