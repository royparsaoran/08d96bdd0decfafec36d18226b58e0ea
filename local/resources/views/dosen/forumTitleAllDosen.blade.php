...
<style>
  ...
  .headertb {
    ...
    background: -webkit-linear-gradient(to right, #7474BF, #348AC7, #7474BF);
      ...
      <div class="x_panel">
        ...
        <table id="datatable" class="table table-hover" style="table-layout: fixed;">
          ...
          <tr class="custab active">
            ...
            <td style="">
              <a href="{{URL::asset('forumThreadPJS/'.$to->post_id.'?page=1' ) }}">
        ...
        <a type="button" class="btn btn-primary btn-lg pull-left btn-round" href="{{ URL::asset('/forumTitleMKDosen') }}">
