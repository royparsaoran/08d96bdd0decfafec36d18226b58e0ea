      ...
      <div class="col-md-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            @endif
            <span>
              <a href="forumNewPostMK" class="btn btn-primary btn-round"><b>+</b>
                Create
                Post</a>
              <a href="forumActiveness" class="btn btn-primary btn-round"><b>+</b>
                Activity</a>
            ...
            <table id="datatable" class="table table-hover" style="table-layout: fixed;">
              ...
              <thead>
                <tr class="custab active">
                  ...
                  <th scope="col" style="width:10%;" class="info">Post</th>
              ...
              <tr class="custab active">
                <td> <span class="fa fa-comments" style="font-size:36px"></span></td>
                <td>
                  <a href="{{URL::asset('forumTitleList/'.$to->post_id ) }}">
                ...
                <td> {{ $to->postcount}}</td>
                <td>
                  <?php if($to->posttimestamp>$to->timestamp){ ?>
                  <div>{{ date('d/M/Y', strtotime($to->posttimestamp))}}</div>
                  <div>{{ date('H:i:s ', strtotime($to->posttimestamp))}}</div>
                  <?php } else{?>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <a href="{{ URL::asset('forumDosen/delete/'.$to->post_id) }}" class="btn btn-danger btn-round">
                          OK</a>
                      </div>
                ...
                <td class="xs"><a data-toggle="modal" href="#myModal_{{ $to->post_id }}" id="alert-demo"
                    name="remove_levels">
                    <span class="btn glyphicon glyphicon-trash btn-lg" style="color:red;"></span></td>
                <?php }else{ ?>
                <td  class="xs"></td>
                <?php }?>
              </tr>
            ...
            <a type="button" class="btn btn-primary btn-lg pull-right btn-round"
              href="{{ URL::asset('/forumTitlePublicDosen') }}">Forum Umum <i
                class="glyphicon glyphicon-chevron-right"></i></a>
            <?php if($roles=="PJS") {?>
            <a type="button" class="btn btn-primary btn-lg btn-round" href="{{ URL::asset('/forumTitleAllDosen') }}">All Forum
            </a>
            <?php } ?>
            {{--  --}}
          </div>
