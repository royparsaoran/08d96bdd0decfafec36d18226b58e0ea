      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
                    {!! Form::open(['method' => 'POST' , 'action' => ['bankSoalController@updateSoalIsian',$banksoal->id,$curIsian->id] ,  'class' => 'form-horizontal form-label-left','enctype'=> "multipart/form-data"
  ,]  ) !!}


                                  <div class="form-group">
                                    <label>Title</label>
                                    <input type="text" class="form-control" id="title" name="title" value="{{$curIsian->title}}" >
                                  </div>

                                  <div class="form-group">
                                     <label>Soal Isian</label>
                                        <textarea name="soal" id="soal" rows="20" class="form-control">{{$curIsian->soal}}</textarea>
                                  </div>
                                  <div class="form-group">
                                    <label for="gambar">Gambar</label>
                                    <input id="gambar" type="file" name="gambar" value="{{$curIsian->gambar}}" >
                                  </div>

                                  <div class="form-group">
                                    <label>Kunci Jawaban (<b><font color="red">CASE SENSITIVE</font></b>)</label>
                                    <input type="text" class="form-control" placeholder="" name="kunciJawaban" id="kunciJawaban" value="{{$curIsian->kunciJawaban}}">
                                  </div>

                                  <div class="form-group">
                                    <label>Kategori</label>
                                    <select class="form-control" required="required" id="kategori" name="kategori" >
                                      <?php if ($curIsian->kategori == "programming"): ?>
                                      ...
                                      <?php elseif ($curIsian->kategori == "jaringan"): ?>
                                        ...
                                        <option value="perulangan">Perulangan</option>
                                        <option value="matriks">Matriks</option>
                                      <?php elseif ($curIsian->kategori == "mulitmedia"): ?>
                                        <option value="programming">Programming</option>
                                        <option value="jaringan">Jaringan</option>
                                        ...
                                        <option value="perulangan">Perulangan</option>
                                        <option value="matriks">Matriks</option>
                                      <?php elseif ($curIsian->kategori == "sisteminformasi"): ?>
                                        <option value="programming">Programming</option>
                                        <option value="jaringan">Jaringan</option>
                                        <option value="mulitmedia">Multimedia</option>
                                        ...
                                        <option value="perulangan">Perulangan</option>
                                        <option value="matriks">Matriks</option>
                                      <?php elseif ($curIsian->kategori == "mobile"): ?>
                                        <option value="programming">Programming</option>
                                        <option value="jaringan">Jaringan</option>
                                        <option value="mulitmedia">Multimedia</option>
                                        <option value="sisteminformasi">Sistem Informasi</option>
                                        ...
                                        <option value="perulangan">Perulangan</option>
                                        <option value="matriks">Matriks</option>
                                      <?php elseif ($curIsian->kategori == "game"): ?>
                                        <option value="programming">Programming</option>
                                        <option value="jaringan">Jaringan</option>
                                        <option value="mulitmedia">Multimedia</option>
                                        <option value="sisteminformasi">Sistem Informasi</option>
                                        ...
                                        <option value="perulangan">Perulangan</option>
                                        <option value="matriks">Matriks</option>
                                      <?php elseif ($curIsian->kategori == "array"): ?>
                                        <option value="programming">Programming</option>
                                        <option value="jaringan">Jaringan</option>
                                        <option value="mulitmedia">Multimedia</option>
                                        <option value="sisteminformasi">Sistem Informasi</option>
                                        ...
                                        <option value="perulangan">Perulangan</option>
                                        <option value="matriks">Matriks</option>
                                      <?php elseif ($curIsian->kategori == "perulangan"): ?>
                                        <option value="programming">Programming</option>
                                        <option value="jaringan">Jaringan</option>
                                        <option value="mulitmedia">Multimedia</option>
                                        <option value="sisteminformasi">Sistem Informasi</option>
                                        ...
                                        <option value="matriks">Matriks</option>
                                      <?php elseif ($curIsian->kategori == "matriks"): ?>
                                        <option value="programming">Programming</option>
                                        <option value="jaringan">Jaringan</option>
                                        <option value="mulitmedia">Multimedia</option>
                                        <option value="sisteminformasi">Sistem Informasi</option>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <select class="form-control" required="required" id="level" name="level" >
                                      <?php if ($curIsian->level == "easy"): ?>
                                        <option value="easy" selected="selected" >Easy</option>
                                        <option value="medium" >Medium</option>
                                        <option value="hard" >Hard</option>
                                      <?php elseif ($curIsian->level == "medium"): ?>
                                        <option value="easy" >Easy</option>
                                        <option value="medium" selected >Medium</option>
                                        <option value="hard" >Hard</option>
                                      <?php elseif ($curIsian->level == "hard"): ?>
                                        <option value="easy" >Easy</option>
                                        <option value="medium" >Medium</option>
