        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <div class="col-12">
              ...
              <form class="form-inline" action="{{ URL::asset("/forumTitlePublic/search") }}" method="POST">
            ...
            <table id="datatable" class="table table-hover" style="table-layout: ;">
              ...
              <tr class="custab active">
                ...
                <td style="width:5%;">  <span class="fa fa-comments" style="font-size:36px"></span></td>

                <td style="width:45%;">

                  <a href="{{URL::asset('forumThread/'.$to->post_id.'?page=1' ) }}">
            ...
            <a type="button" class="btn btn-primary btn-lg pull-left btn-round" href="{{ URL::asset('/forumTitleMK') }}">
